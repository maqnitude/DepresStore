...
namespace DepresStore.Shared.Infrastructure
{
    /// <summary>
    /// [DEPRECATED]
    /// This implememtation requires manual handler subscription.
    /// </summary>
    public class InProcessEventBusDeprecated : IEventBus
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ILogger<InProcessEventBusDeprecated> _logger;

        private readonly ConcurrentDictionary<Type, List<Type>> _eventHandlers = new();

        public InProcessEventBusDeprecated(
            IServiceProvider serviceProvider,
            ILogger<InProcessEventBusDeprecated> logger)
        {
